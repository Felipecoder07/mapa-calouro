...
export default function PlaceDetails({
  ...
  const activeDistance = useMemo(() => {
    ...
    return haversineDistance(UNIVERSITY.lat, UNIVERSITY.lng, place.lat, place.lng);
          ...
          <div className="mt-4 rounded-2xl bg-slate-50 border border-slate-100 p-3 space-y-2.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`flex items-center justify-center gap-1.5 rounded-xl py-2 px-2.5 text-xs font-semibold transition border ${
